...
class Playlist implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'description' => 'string',
        'children' => '\Api42Vb\Client\Model\Video[]',
        'ctime' => 'int',
        'mtime' => 'int'
    ];
    ...
    */
     ...
     * Sets id
     *
     * @param string $id id of the playlist (null when adding a new video)
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Playlist., must be smaller than or equal to 256.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Playlist., must be smaller than or equal to 2048.');
        }
     ...
     * Sets children
     *
     * @param \Api42Vb\Client\Model\Video[]|null $children ordered list of video in the playlist
     *
     * @return self
     */
